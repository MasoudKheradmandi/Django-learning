...
class RegistrationsSerializers(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            # print(type(serializers.ValidationError({"password":e.messages})))
...
class SerializersProfile(serializers.ModelSerializer):
...
class ResendVerificationsSerializers(serializers.Serializer):
